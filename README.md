...
<body>
  ...
  <audio id="fire-sound" src="https://singular-kitsune-ceed23.netlify.app/crash-7075.mp3" preload="auto"></audio>
  <audio id="hit-sound" src="https://singular-kitsune-ceed23.netlify.app/explosion-fx-343683.mp3" preload="auto"></audio>
  <audio id="miss-sound" src="https://singular-kitsune-ceed23.netlify.app/water-splash-02-352021.mp3" preload="auto"></audio>
  <audio id="victory-sound" src="https://singular-kitsune-ceed23.netlify.app/11l-victory-1749704552668-358772.mp3" preload="auto"></audio>
  <audio id="defeat-sound" src="https://singular-kitsune-ceed23.netlify.app/game-over-39-199830.mp3" preload="auto"></audio>
  <audio id="ui-sound" src="https://singular-kitsune-ceed23.netlify.app/ui-sound-270349.mp3" preload="auto"></audio>
...
function unlockAudio(){
  ...
  audioUnlocked=true;
  sfxElems.forEach(a=>{if(a){a.muted=audioMuted;a.play().catch(()=>{});a.pause();a.currentTime=0;}});
  if(bgMusic){bgMusic.muted=audioMuted;bgMusic.play().catch(()=>{});bgMusic.pause();bgMusic.currentTime=0;}
}
